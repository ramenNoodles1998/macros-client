...
import { incrementProteinByAmountAsync, incrementCarbsByAmountAsync, incrementFatByAmountAsync, selectProtein, selectCarbs, selectFat } from '../../feature/macro-slice';
      ...
      <Modal
        ...
        <View className="m-auto bg-teal-800 shadow-2xl rounded">
          <View className="flex justify-end pb-3  bg-teal-900 pt-1 px-1">
            ...
            <MacroText className="self-center text-lg">Quick Add {props.modalType}</MacroText>
          </View>
