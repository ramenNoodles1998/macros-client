        ...
        <View className="mt-3">
            <View className="flex flex-row justify-right">
                <Pressable 
                    ...
                    className={'px-3 ml-3 mr-1 pt-1 rounded-t ' + (!showAddMacros ? 'bg-teal-900 ' : 'bg-teal-800 ')}
                >
                    <MacroText className="text-lg">
                        Macros
                    </MacroText>
                </Pressable>
                <Pressable 
                    onPress={() => setShowAddMacros(!showAddMacros)}
                    className={'px-3 pt-1 rounded-t ' + (showAddMacros ? 'bg-teal-900 ' : 'bg-teal-800 ')}
                >
                    <MacroText className="text-lg">
                       Logs 
                    </MacroText>
